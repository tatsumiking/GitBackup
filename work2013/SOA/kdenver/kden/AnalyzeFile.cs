...
namespace kden
{
    ...
    public class AnalyzeFile
    {
        ...
        public string m_sSouke;
        public int m_nSumPrice;
        public string m_sTuya;
        public string m_sKokubetu;
        public string m_sSekou;
        public List<hanbai> m_list;

        private string m_sKaisya1;
        private string m_sKaisya2;
        private string m_sPostNo;
        private string m_sAddress;
        private string m_sTel;
        private string m_sFax;
        private string[] m_sBank;
        private string[] m_sNouhin;
