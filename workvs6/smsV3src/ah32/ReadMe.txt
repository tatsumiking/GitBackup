========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ah32
========================================================================


AppWizard が生成した ah32 には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ah32 を構成している各ファイルの概要説明が含まれています。
...
ah32.h
    ...
    みます） をインクルードし、また CAh32App アプリケーションクラスを宣
    言します。

ah32.cpp
    このファイルは CAh32App アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ah32.ico
    ...
    ルです。このアイコンはリソース ファイル ah32.rc によってインクルード
    されます。
...
ah32Dlg.h, ah32Dlg.cpp - ダイアログ
    これらのファイルは CAh32Dlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な ah32.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ah32.pch 
