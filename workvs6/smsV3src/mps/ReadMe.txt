========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : mps
========================================================================


AppWizard が生成した mps には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには mps を構成している各ファイルの概要説明が含まれています。
...
res\mps.ico
    ...
    ルです。このアイコンはリソース ファイル mps.rc によってインクルード
    されます。
...
mpsDlg.h, mpsDlg.cpp - ダイアログ
    これらのファイルは CTonDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な mps.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) mps.pch 
