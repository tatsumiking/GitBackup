...
protected:
	...
	void GetPaperName(DBL srcxmm, DBL srcymm, LPSTR retpapername);
	void GetPaperSize(LPSTR srcpapername, DBL *retxmm, DBL *retymm);
	// 生成されたメッセージ マップ関数
