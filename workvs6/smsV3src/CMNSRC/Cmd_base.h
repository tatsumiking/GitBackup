...
public:
	...
	virtual void HlpMsgDsp(LPSTR msg);
	virtual void HlpMsgDsp(int no, LPSTR msg);
	...
	virtual int SetDataListForStrgText(int nSelectID, CStrgText *pcSelectData);
	virtual int SetDataListForSPtnText(int nSelectID, CSPtnText *pcSelectData);
	virtual int SetDataListForSWakText(int nSelectID, CSWakText *pcSelectData);
	virtual int SetDataListForNameGrup(int nSelectID, CNameGrup *pcSelectData);
	virtual int SetDataListForMojiText(int nSelectID, CMojiText *pcSelectData);
