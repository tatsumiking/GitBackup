...
BOOL CDialogSendDetails::OnInitDialog() 
{
...
void CDialogSendDetails::OnSelchangeCbpaperkind() 
{
	int	selno;
...
void CDialogSendDetails::OnSelchangeCbprocess() 
{
	int		selno;
	char	buf[RECMAX];
	char	name[32];
...
void CDialogSendDetails::PaperDefLoad()
{
	char	exepath[FNAMEMAX];
	char	fname[FNAMEMAX];
	FILE	*fp;
...
void CDialogSendDetails::PaperListInit()
{
	char	exepath[FNAMEMAX];
	char	fname[FNAMEMAX];
	FILE	*fp;
