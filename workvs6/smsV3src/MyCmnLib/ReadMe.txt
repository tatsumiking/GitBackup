========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : MyCmnLib
========================================================================


AppWizard が生成した MyCmnLib には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには MyCmnLib を構成している各ファイルの概要説明が含まれています。
...
MyCmnLib.h
	...
	CMyCmnLibApp アプリケーションクラスを宣言します。

MyCmnLib.cpp
	このファイルは CMyCmnLibApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) MyCmnLib.pch 
