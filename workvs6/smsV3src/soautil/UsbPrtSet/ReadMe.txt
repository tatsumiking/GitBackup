========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : UsbPrtSet
========================================================================


AppWizard が生成した UsbPrtSet には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには UsbPrtSet を構成している各ファイルの概要説明が含まれています。
...
UsbPrtSet.h
    ...
    みます） をインクルードし、また CUsbPrtSetApp アプリケーションクラスを宣
    言します。

UsbPrtSet.cpp
    このファイルは CUsbPrtSetApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\UsbPrtSet.ico
    ...
    ルです。このアイコンはリソース ファイル UsbPrtSet.rc によってインクルード
    されます。
...
UsbPrtSetDlg.h, UsbPrtSetDlg.cpp - ダイアログ
    これらのファイルは CUsbPrtSetDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な UsbPrtSet.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) UsbPrtSet.pch 
