========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : prtct
========================================================================


AppWizard が生成した prtct には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには prtct を構成している各ファイルの概要説明が含まれています。
...
prtct.h
    ...
    みます） をインクルードし、また CPrtctApp アプリケーションクラスを宣
    言します。

prtct.cpp
    このファイルは CPrtctApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\prtct.ico
    ...
    ルです。このアイコンはリソース ファイル prtct.rc によってインクルード
    されます。
...
prtctDlg.h, prtctDlg.cpp - ダイアログ
    これらのファイルは CPrtctDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な prtct.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) prtct.pch 
