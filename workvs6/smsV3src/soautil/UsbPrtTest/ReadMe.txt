========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : UsbPrtTest
========================================================================


AppWizard が生成した UsbPrtTest には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには UsbPrtTest を構成している各ファイルの概要説明が含まれています。
...
res\UsbPrtTest.ico
    ...
    ルです。このアイコンはリソース ファイル UsbPrtTest.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、UsbPrtTest.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) UsbPrtTest.pch 
