...
NewFileInclude2=#include "UsbPrtTest.h"
LastPage=0
...
Resource3=IDR_USBPRTTYPE

[CLS:CTonApp]
Type=0
HeaderFile=UsbPrtTest.h
ImplementationFile=UsbPrtTest.cpp
Filter=N

[CLS:CTonDoc]
Type=0
HeaderFile=UPTDoc.h
ImplementationFile=UPTDoc.cpp
Filter=N

[CLS:CTonView]
Type=0
HeaderFile=UPTView.h
ImplementationFile=UPTView.cpp
Filter=C
