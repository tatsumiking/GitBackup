========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : wr32
========================================================================


AppWizard が生成した wr32 には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには wr32 を構成している各ファイルの概要説明が含まれています。
...
wr32.h
    ...
    みます） をインクルードし、また CWr32App アプリケーションクラスを宣
    言します。

wr32.cpp
    このファイルは CWr32App アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\wr32.ico
    ...
    ルです。このアイコンはリソース ファイル wr32.rc によってインクルード
    されます。
...
wr32Dlg.h, wr32Dlg.cpp - ダイアログ
    これらのファイルは CWr32Dlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な wr32.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) wr32.pch 
