...
void CBoldLib::BmpFileOut(LPSTR fname, BYTE far *m_lpBits, int xbyte, int xsize, int ysize)
{
	FILE				*fp;
...
BmpFileOut("c:\\image.bmp", lpTBits, xbyte, xsize, ysize);
