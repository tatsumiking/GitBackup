...
void CMsurVect::Serialize(CArchive& ar)
{
	...
	else
	{
		...
		ar >> m_nType;
		ar >> csMsurStrg;
		lstrcpy(m_szMsurStrg, csMsurStrg);
		ar >> m_dFontSize;
		ar >> csFontName;
...
void CMsurVect::SetMsurStrg(LPSTR spMsurStrg)
{
	strcpy(m_szMsurStrg, spMsurStrg);
}

void CMsurVect::GetMsurStrg(LPSTR spMsurStrg)
{
	strcpy(spMsurStrg, m_szMsurStrg);
}
...
void CMsurVect::SetFontName(LPSTR spFontName)
{
	strcpy(m_szFontName, spFontName);
}

void CMsurVect::GetFontName(LPSTR spFontName)
{
	strcpy(spFontName, m_szFontName);
}
...
void CMsurVect::TextDrow(CDC *pcDC, DBL sx, DBL sy, DBL ex, DBL ey, LPSTR strg, int len)
{
	HFONT	hF, oldhF;
	DBL		dFW, dFH, rag;
	int		x, y;
