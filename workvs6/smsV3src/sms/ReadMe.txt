========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : sms
========================================================================


AppWizard が生成した sms には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには sms を構成している各ファイルの概要説明が含まれています。
...
res\sms.ico
    ...
    ルです。このアイコンはリソース ファイル sms.rc によってインクルード
    されます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) sms.pch 
