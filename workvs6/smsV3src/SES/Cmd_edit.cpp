...
UINT CCmdEdit::ExecPMove(UINT event, DBL dx, DBL dy)
{
	...
	case RESETEVENT:
		if(m_nFirstFlag == ON){
			if(AfxMessageBox("ÌßÛ¯À°‚ÍÚ‘±‚³‚ê‚Ä‚¢‚Ü‚·‚©", MB_OKCANCEL, -1) != IDOK){
				return(0);
			}
			m_nFirstFlag = OFF;
		}
...
UINT CCmdEdit::ExecMoveRltv(UINT event, DBL dx, DBL dy)
{
	...
	pDialogInputNum->SetDialogTitle("‰¡•ûŒüˆÚ“®—ÊŽw’è");
	pDialogInputNum->SetUnitText("mm");
	pDialogInputNum->SetTitleText("ˆÚ“®—Ê");
	...
	pDialogInputNum = new CDialogInputNum(m_pcView);
	pDialogInputNum->SetDialogTitle("c•ûŒüˆÚ“®—ÊŽw’è");
	pDialogInputNum->SetUnitText("mm");
	pDialogInputNum->SetTitleText("ˆÚ“®—Ê");
	pDialogInputNum->m_dInputNum = 0;
	if(pDialogInputNum->DoModal() == IDOK){
...
UINT CCmdEdit::ExecMoveCood(UINT event, DBL dx, DBL dy)
{
	...
	pDialogInputNum = new CDialogInputNum(m_pcView);
	pDialogInputNum->SetDialogTitle("‰¡•ûŒüÀ•WˆÊ’uŽw’è");
	pDialogInputNum->SetUnitText("mm");
	pDialogInputNum->SetTitleText("‰¡À•W");
	...
	pDialogInputNum = new CDialogInputNum(m_pcView);
	pDialogInputNum->SetDialogTitle("c•ûŒüÀ•WˆÊ’uŽw’è");
	pDialogInputNum->SetUnitText("mm");
	pDialogInputNum->SetTitleText("cÀ•W");
...
UINT CCmdEdit::ExecCopyRltv(UINT event, DBL dx, DBL dy)
{
	...
	pDialogInputNum = new CDialogInputNum(m_pcView);
	pDialogInputNum->SetDialogTitle("‰¡•ûŒü•¡ŽÊˆÊ’uŽw’è");
	pDialogInputNum->SetUnitText("mm");
	pDialogInputNum->SetTitleText("‰¡•¡ŽÊˆÊ’u");
	pDialogInputNum->m_dInputNum = 0;
	if(pDialogInputNum->DoModal() == IDOK){
		movex = pDialogInputNum->m_dInputNum;
		delete(pDialogInputNum);
	...
	pDialogInputNum = new CDialogInputNum(m_pcView);
	pDialogInputNum->SetDialogTitle("c•ûŒü•¡ŽÊˆÊ’uŽw’è");
	pDialogInputNum->SetUnitText("mm");
	pDialogInputNum->SetTitleText("c•¡ŽÊˆÊ’u");
	pDialogInputNum->m_dInputNum = 0;
	if(pDialogInputNum->DoModal() == IDOK){
		movey = pDialogInputNum->m_dInputNum;
		delete(pDialogInputNum);
