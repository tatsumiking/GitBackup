...
static TCHAR crctfilter[] = _T("筆耕システム 貯込Files (*.rec)|*.rec||");
static TCHAR crctsafixs[] = _T("rec");

CCommand::CCommand(CTonView* pcview)
{
	m_pcView = pcview;
...
void CCommand::SetDocument(CTonDoc* pcDoc)
{
	m_pcDoc = pcDoc;
}
