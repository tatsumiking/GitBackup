...
void CDialogInputNum::SetDialogTitle(LPTSTR lpTitle)
{
	m_lpTitle = lpTitle;
}

void CDialogInputNum::SetUnitText(LPTSTR lpUnitText)
{
	m_lpUnitText = lpUnitText;
}

void CDialogInputNum::SetTitleText(LPTSTR lpTitleText)
{
