...
void CBmpFile::CreateBmpImage(int movex, int movey, COLORREF clr, LPTSTR fname)
{
	DBL		sizex, sizey;
	int		bmode;
	DBL		btime;
...
void CBmpFile::CreateBmpImageHalf(int movex, int movey, COLORREF clr, LPTSTR fname)
{
	DBL		sizex, sizey;
	int		bmode;
	DBL		btime;
...
void CBmpFile::CreateBmpImage(LPTSTR fname)
{
...
void CBmpFile::CreateBmpImageRv(LPTSTR fname)
{
	AreaOnDraw(0, 0, m_nXDotMax, m_nYDotMax);
...
void CBmpFile::CreateBmpImageDivRv(LPTSTR fname)
{
	TCHAR	tmppath[FNAMEMAX];
	TCHAR	tmpfile1[FNAMEMAX];
	TCHAR	tmpfile2[FNAMEMAX];

	senvgettmppath((LPTSTR)tmppath);
	_stprintf_s((LPTSTR)tmpfile1, FNAMEMAX, _T("%s\\temp1.bmp"), tmppath);
	_stprintf_s((LPTSTR)tmpfile2, FNAMEMAX, _T("%s\\temp2.bmp"), tmppath);

	AreaOnDraw1(0, 0, m_nXDotMax, m_nYDotMax);
	BmpFileOutRv((LPTSTR)tmpfile1, m_nXDotMax/2, m_nYDotMax);
	BmpFileOutRv1(fname, m_nXDotMax, m_nYDotMax);
	AreaOnDraw2(0, 0, m_nXDotMax, m_nYDotMax);
	BmpFileOutRv((LPTSTR)tmpfile2, m_nXDotMax/2, m_nYDotMax);
	BmpFileOutRv2(fname, m_nXDotMax, m_nYDotMax);
}

void CBmpFile::CreateBmpImageDiv(LPTSTR fname)
{
	TCHAR	tmppath[FNAMEMAX];
	TCHAR	tmpfile1[FNAMEMAX];
	TCHAR	tmpfile2[FNAMEMAX];
	...
	AreaOnDraw1(0, 0, m_nXDotMax, m_nYDotMax);
	BmpFileOut((LPTSTR)tmpfile1, m_nXDotMax/2, m_nYDotMax);
	BmpFileOut1(fname, m_nXDotMax, m_nYDotMax);
	AreaOnDraw2(0, 0, m_nXDotMax, m_nYDotMax);
	BmpFileOut((LPTSTR)tmpfile2, m_nXDotMax/2, m_nYDotMax);
	BmpFileOut2(fname, m_nXDotMax, m_nYDotMax);
}

void CBmpFile::CreateBmpOnebitImage(LPTSTR fname)
{
	AreaOnDraw(0, 0, m_nXDotMax, m_nYDotMax);
...
void CBmpFile::CreateBmpOnebitImageRV(LPTSTR fname)
{
	AreaOnDraw(0, 0, m_nXDotMax, m_nYDotMax);
...
void CBmpFile::AreaOnDraw(int sx, int sy, int ex, int ey)
{
	...
	EndDraw();
	//TCHAR msgbuf[RECMAX];
	//_stprintf_s(msgbuf, "確認　sx %4.1lf sy %4.1lf ex %4.1lf ey %4.1lf", sx, sy, ex, ey); 
...
void CBmpFile::BmpFileOut(LPTSTR fname, int xdot, int ydot)
{
	FILE	*fp;
	BITMAPINFO	bmpinfo;
...
void CBmpFile::BmpFileOut1(LPTSTR fname, int xdot, int ydot)
{
	FILE	*fp;
	BITMAPINFO	bmpinfo;
	BITMAPFILEHEADER	bmpfh;
...
void CBmpFile::BmpFileOut2(LPTSTR fname, int xdot, int ydot)
{
	FILE	*fp;
	BITMAPINFO	bmpinfo;
	LPBYTE	lpByte;
...
void CBmpFile::BmpFileOutRv(LPTSTR fname, int xdot, int ydot)
{
	FILE	*fp;
	BITMAPINFO	bmpinfo;
	BITMAPFILEHEADER	bmpfh;
...
void CBmpFile::BmpFileOutRv1(LPTSTR fname, int xdot, int ydot)
{
	FILE	*fp;
	BITMAPINFO	bmpinfo;
	BITMAPFILEHEADER	bmpfh;
...
void CBmpFile::BmpFileOutRv2(LPTSTR fname, int xdot, int ydot)
{
	FILE	*fp;
	BITMAPINFO	bmpinfo;
	LPBYTE	lpByte;
...
void CBmpFile::BmpOnebitFileOutRV(LPTSTR fname, int xdot, int ydot)
{
	FILE	*fp;
	BITMAPINFO	bmpinfo;
	BITMAPFILEHEADER	bmpfh;
...
void CBmpFile::BmpOnebitFileOut(LPTSTR fname, int xdot, int ydot)
{
	FILE	*fp;
	BITMAPINFO	bmpinfo;
	BITMAPFILEHEADER	bmpfh;
...
void CBmpFile::BmpFileOutHalf(LPTSTR fname, int xdot, int ydot)
{
	int		setxdot, setydot;
	FILE	*fp;
	BITMAPINFO	bmpinfo;
