...
BOOL CDialogBmpRound::OnInitDialog() 
{
	...
	m_cbRoundKind.AddString(_T("１８０°回転"));
	m_cbRoundKind.AddString(_T("左９０°回転"));
	m_cbRoundKind.AddString(_T("右９０°回転"));
	m_cbRoundKind.AddString(_T("上下反転"));
	m_cbRoundKind.AddString(_T("左右反転"));
