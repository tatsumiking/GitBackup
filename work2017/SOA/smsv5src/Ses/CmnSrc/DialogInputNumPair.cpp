...
void CDialogInputNumPair::SetDialogTitle(LPTSTR lpTitle)
{
	m_lpTitle = lpTitle;
}

void CDialogInputNumPair::SetUnitText(LPTSTR lpUnitTextX, LPTSTR lpUnitTextY)
{
	m_lpUnitTextX = lpUnitTextX;
	m_lpUnitTextY = lpUnitTextY;
}

void CDialogInputNumPair::SetTitleText(LPTSTR lpTitleTextX, LPTSTR lpTitleTextY)
{
