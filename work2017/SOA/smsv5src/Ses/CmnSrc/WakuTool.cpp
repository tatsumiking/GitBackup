...
void CWakuTool::SetItemElement()
{
	...
	_stprintf_s(numstr, _T("%4.1lf"), dmmsx);
	...
	_stprintf_s(numstr, _T("%4.1lf"), dmmsy);
	...
	_stprintf_s(numstr, _T("%4.1lf"), dwidth);
	...
	_stprintf_s(numstr, _T("%4.1lf"), dhight);
	...
	_stprintf_s(numstr, _T("%4.1lf"), dmojicount);
