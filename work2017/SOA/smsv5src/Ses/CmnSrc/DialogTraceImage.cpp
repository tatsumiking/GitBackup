...
void CDialogTraceImage::KeyIn(UINT nTCHAR, UINT nID)
{
...
void CDialogTraceImage::SetImage(LPTSTR lpBmpFname)
{
	CFile	cpFile;
	LPBYTE	lpDib;
	ULONG	filesize;

	_tcscpy_s(m_szBmpFname, lpBmpFname);
