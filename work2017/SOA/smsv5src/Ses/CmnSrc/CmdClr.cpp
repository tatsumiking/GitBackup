...
UINT CCmdClr::ExecClrPicup(UINT event, DBL dx, DBL dy)
{
	...
	case SETEVENT:
		...
		if(pcData != NULL){
			...
			SetToolBarElement();
			_stprintf_s(msg, _T("塗潰%03d(R%03d, G%03d, B%03d)　線%03d(R%03d, G%03d, B%03d) 線幅(%4.1lf)"),
